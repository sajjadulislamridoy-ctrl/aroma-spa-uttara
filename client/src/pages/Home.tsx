  ...
  return (
    <div className="w-full bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <img 
              src="/manus-storage/058a29a0-6b5c-11f1-a3cc-fbd4bae1063e(2)-LT5ZWTzwr2FoeyCjZuGkmK.png" 
              alt="Aroma Spa Logo" 
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(https://d2xsxph8kpxj0f.cloudfront.net/310519663774431221/LT5ZWTzwr2FoeyCjZuGkmK/hero-spa-background-3W5gawXUbdFX6Z63kisATq.webp)',
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden h-96">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3649.7519490850446!2d90.38970952346916!3d23.80506357088245!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755c7b8e8e8e8e9%3A0x1234567890abcdef!2sHouse%2029%2C%20Road%203%2FB%2C%20Sector%2009%2C%20Uttara%2C%20Dhaka%201230!5e0!3m2!1sen!2sbd!4v1234567890"
                width="100%"
                height="100%"
                style={{ border: 0 }}
